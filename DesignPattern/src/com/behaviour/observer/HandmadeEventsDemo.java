...
class PropertyChangedEventArgsDemo
{
  public Object source;
  public String propertyName;

  public PropertyChangedEventArgsDemo(Object source, String propertyName)
  {
    this.source = source;
...
class PersonDemo
{
  public Event<PropertyChangedEventArgsDemo>
  ...
  public void setAge(int age)
  {
    ...
    this.age = age;
    propertyChanged.fire(new PropertyChangedEventArgsDemo(
      this, "age"
    ));
...
public class HandmadeEventsDemo
{
  public static void main(String [] args)
  {
    ...
    Event<PropertyChangedEventArgsDemo>.Subscription sub =
